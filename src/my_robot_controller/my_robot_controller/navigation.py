...
class TurtleNavigationNode(Node):
    ...
    def __init__(self):
       ...
       ############# [Initial Location] ############
        ...
        time.sleep(3)
        print("Publish the initial Localization point !!!!!!!!!!!!!!!!!!!!!!!")
       ...
       # Initialize goal poses as dictionaries {x, y, w}
        ...
        self.goal_poses.append({'x': 0.26, 'y': 3.63, 'yaw': 0})
        self.goal_poses.append({'x': -2.2, 'y': 4.3, 'yaw': 60})
        self.goal_poses.append({'x': -6.9, 'y': 2.2, 'yaw': 40})
        self.goal_poses.append({'x': 2.4, 'y': 1.4, 'yaw': 0})
